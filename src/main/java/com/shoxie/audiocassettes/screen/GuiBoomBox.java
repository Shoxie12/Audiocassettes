...
public class GuiBoomBox extends GuiContainer {
    ...
    public GuiBoomBox(TileBoomBox tile, BoomBoxContainer container) {
        super(container);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if(this.container.getSlot(0).getStack().getItem() instanceof AbstractAudioCassetteItem)
        	str = this.container.curr+". "+str;
        else str = "- ";
        drawScaledString(Minecraft.getMinecraft().fontRenderer, str, 69, 22, 0.7F, 0xffffff);
    }
